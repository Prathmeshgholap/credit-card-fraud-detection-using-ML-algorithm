...
🏆 Best Model
Random Forest Classifier
Best balance between detecting fraud & avoiding false alarms Lowest false positives Highest overall F1 score
...
Guided by Punit Kanojiya Sir

📂 Dataset
The dataset used in this project can be accessed from the following link:
👉 [Click here to download the dataset](https://www.kaggle.com/datasets/kartik2112/fraud-detection?utm_source=chatgpt.com)
